      ...
      <div className="p-5 text-left">
        ...
        <div className="mt-4 pt-3 border-t border-slate-100 grid grid-cols-3 gap-2 text-center">
          <div className="bg-slate-50/80 p-2 rounded-xl border border-slate-100">
            ...
            <p className="text-xs font-bold text-slate-800">{worker?.experience || 0} Years</p>
          </div>
          <div className="bg-slate-50/80 p-2 rounded-xl border border-slate-100">
            <p className="text-[10px] text-slate-500 uppercase font-semibold">Completed</p>
            <p className="text-xs font-bold text-slate-800">{worker?.completedJobs || 0} Gigs</p>
          </div>
          <div className="bg-slate-50/80 p-2 rounded-xl border border-slate-100">
