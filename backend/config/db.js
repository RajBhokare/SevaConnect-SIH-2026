...
const connectDB = async () => {
  ...
  try {
    const mongoUri = process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/sevaconnect';
...
const getDBStatus = () => isConnected || (mongoose.connection && mongoose.connection.readyState >= 1);
